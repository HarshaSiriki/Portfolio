...
const experiences = [
  ...
  },
  {
    ...
    points: [
      ...
      "Developed Python-based unit tests for validating Cisco IP Phone APIs, and used OpenCV2 to extract screen data for test automation and edge-case handling.",
      "Authored Python implementation scripts for internal and customer-facing documentation to help clients understand CUCM API usage and reduce support friction.",
      "Escalated confirmed bugs and complex issues to engineering via Jira, providing detailed replication steps and logs to facilitate quicker resolution.",
      "Created structured troubleshooting SOPs, internal knowledge articles, and reusable workflows to improve first-time resolution rates across the team.",
      "Mentored new support engineers on diagnostic processes, ticket triaging, and tool usage—accelerating their onboarding and performance.",
      "Led Python mentoring sessions for senior technical support peers to help the team expand their automation and scripting capabilities.",
      "Represented Cisco on internal forums and DevNet channels, assisting external developers with CUCM API best practices and usage patterns.",
    ],
  },
];
